...
import { Configuration, type ConfigurationParameters } from '$api/infra'
import type { PageServerLoad } from '@sveltejs/kit'

const configuration = getConfiguration()
const clientConfig = configuration.clients[ApiClientID.Infra]
 ...
 */
export function createAuthenticationConfig(event: PageServerLoad, overrides: Partial<ConfigurationParameters> = {}) {
